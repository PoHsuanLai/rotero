...
CREATE TABLE IF NOT EXISTS papers (
    ...
    title_ua INTEGER NOT NULL DEFAULT 0,
    title_ub TEXT NOT NULL DEFAULT '',
    authors_ua INTEGER NOT NULL DEFAULT 0,
    authors_ub TEXT NOT NULL DEFAULT '',
    year_ua INTEGER NOT NULL DEFAULT 0,
    year_ub TEXT NOT NULL DEFAULT '',
    doi_ua INTEGER NOT NULL DEFAULT 0,
    doi_ub TEXT NOT NULL DEFAULT '',
    abstract_text_ua INTEGER NOT NULL DEFAULT 0,
    abstract_text_ub TEXT NOT NULL DEFAULT '',
    journal_ua INTEGER NOT NULL DEFAULT 0,
    journal_ub TEXT NOT NULL DEFAULT '',
    volume_ua INTEGER NOT NULL DEFAULT 0,
    volume_ub TEXT NOT NULL DEFAULT '',
    issue_ua INTEGER NOT NULL DEFAULT 0,
    issue_ub TEXT NOT NULL DEFAULT '',
    pages_ua INTEGER NOT NULL DEFAULT 0,
    pages_ub TEXT NOT NULL DEFAULT '',
    publisher_ua INTEGER NOT NULL DEFAULT 0,
    publisher_ub TEXT NOT NULL DEFAULT '',
    url_ua INTEGER NOT NULL DEFAULT 0,
    url_ub TEXT NOT NULL DEFAULT '',
    pdf_path_ua INTEGER NOT NULL DEFAULT 0,
    pdf_path_ub TEXT NOT NULL DEFAULT '',
    pdf_sha256_ua INTEGER NOT NULL DEFAULT 0,
    pdf_sha256_ub TEXT NOT NULL DEFAULT '',
    date_added_ua INTEGER NOT NULL DEFAULT 0,
    date_added_ub TEXT NOT NULL DEFAULT '',
    date_modified_ua INTEGER NOT NULL DEFAULT 0,
    date_modified_ub TEXT NOT NULL DEFAULT '',
    is_favorite_ua INTEGER NOT NULL DEFAULT 0,
    is_favorite_ub TEXT NOT NULL DEFAULT '',
    is_read_ua INTEGER NOT NULL DEFAULT 0,
    is_read_ub TEXT NOT NULL DEFAULT '',
    extra_meta_ua INTEGER NOT NULL DEFAULT 0,
    extra_meta_ub TEXT NOT NULL DEFAULT '',
    citation_count_ua INTEGER NOT NULL DEFAULT 0,
    citation_count_ub TEXT NOT NULL DEFAULT '',
    item_type_ua INTEGER NOT NULL DEFAULT 0,
    item_type_ub TEXT NOT NULL DEFAULT '',
